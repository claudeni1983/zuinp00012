					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Princípios de negócio responsável",
									"targetURL": "#zuinp00012-display"
								}
							}]
						}]
					}
						...
						"inbounds": {
							"zuinp00012-display": {
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=zuinp00012",
									"url": sap.ui.require.toUrl("zuinp00012")
								}
							}
						}
					}
